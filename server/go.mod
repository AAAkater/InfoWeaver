...
require (
	...
	github.com/milvus-io/milvus-proto/go-api/v2 v2.6.11 // indirect
	github.com/milvus-io/milvus/pkg/v2 v2.6.11 // indirect
	...
	github.com/ollama/ollama v0.20.2 // indirect
