...
const columns: DataTableColumns<Api.Dataset.ChunkInfo> = [
  ...
  },
  {
    ...
    render(row) {
      const metadata = row.chunk_metadata ? JSON.stringify(row.chunk_metadata) : '-';
...
<template>
  <NSpace vertical :size="16">
    ...
    <NCard :bordered="false">
      <NDataTable :columns="columns" :data="chunks" :loading="loading" :bordered="false" size="small" remote />
