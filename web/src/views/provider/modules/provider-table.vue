...
import { Delete16Regular as DeleteIcon, Edit24Regular as EditIcon, Server24Regular } from '@vicons/fluent';
...
<template>
  <NDataTable :columns="columns" :data="props.providers" :bordered="false" :single-line="false" size="small" />
</template>
