...
<template>
  <ConfigProvider>
    <div class="color-#fff">
      <ProCard
        :title="$t('page.proNaive.form.step.title')"
        ...
        <div class="flex flex-col items-center justify-center">
          ...
          <template v-if="step === 1">
            <ProForm :form="form" label-placement="left">
              <ProInput
                :title="$t('page.proNaive.form.step.step1.field')"
                path="form1Field"
                required
              />
              <NButton @click="toNextStepAfterValidated">{{
          ...
          <template v-if="step === 2">
            <ProForm :form="form2" :loading="submiting" label-placement="left">
              <ProInput
                :title="$t('page.proNaive.form.step.step2.field')"
                path="form2Field"
                required
              />
              <NFlex>
